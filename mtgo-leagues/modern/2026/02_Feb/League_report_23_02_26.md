...
4 Scion of Draco (S)
2 Formidable Speaker (FS)
3 Phlage, Titan of Fire's Fury (PH)
3 Ragavan, Nimble Pilferer (RAG)
2 Quantum Riddler (QR)
    
## Spells
2 Stubborn Denial (STD)
4 Lightning Bolt (B)
3 Leyline Binding (BI)
1 Surge of Salvation (SOS)
1 Path to Exile (PTE)
4 Leyline of the Guildpact (LOTG)
3 Strix Serenade (STS)
...
Draw Pattern: Second land turn 6

Mistake: Nie skontrowałem Flickerwhisp STS
...
Tags: Mana Flood, Execution mistake

Decision:

Draw Pattern: Flood 

Mistake: Niepotrzebnie zabiłem Phelia end of turn za pomoca B majac STS i SOS na rece 
...
Opening:
[PH PH T3F QR S K RAG]

Mulligan

Hand Type: No Lander

Second Hand: [TF F F F QR PH QR]

Mulligan

Hand Type: Too Slow

Third Hand: [T3F B F F F STS F] - bottom F F

Keep

Hand Type: No threads
...
Draw Pattern: Did not draw threat in 5 turns only interreaction 

Mistake: brak

Opponent Key Interaction:  Slick-shot + mutagenic growth
...
Card Notes: FS pozwolił isc po Kavu i zagrac go z hastem dzieki temu był lethal
...
Opening: [K AOG SV STD FS LOTG GS]
...
Opponent Key Interaction: zdazył mnie przewinac mimo ze był na 2 hp
...
Opponent Key Interaction: bardzo duza kreatura na która nie miałem odpowiedzi 
...
Opening:[TF LOTG PH QR SV WOTS M]

Keep

Hand Type: Slow with SB hate
...
Card Notes: Dobrze ze keepnołem reke z WOTS bo przeciwnik sie wysypał w T2 dzieki temu wyczysciłem jego kreatury
...
Opening: [S LOTG TG F F F PTE FS]


Keep

Hand Type: Good With Combo
